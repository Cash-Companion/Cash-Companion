        ...
        <Navbar.Collapse id={COMPONENT_IDS.NAVBAR_COLLAPSE}>
          <Nav className="me-auto justify-content-start">
            {currentUser ? ([
              ...
              <Nav.Link id={COMPONENT_IDS.NAVBAR_ADD_EXPENSE} as={NavLink} to="/add-expense" key="add">Add Expense</Nav.Link>,
              <Nav.Link id={COMPONENT_IDS.NAVBAR_LIST_STUFF} as={NavLink} to="/list" key="list">List Stuff</Nav.Link>,
              <Nav.Link id={COMPONENT_IDS.NAVBAR_LIST_EXPENSE} as={NavLink} to="/list-expense" key="list">List Expense</Nav.Link>,
            ]) : ''}
