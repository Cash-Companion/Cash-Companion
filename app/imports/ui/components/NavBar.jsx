...
const NavBar = () => {
  ...
  return (
    <Navbar bg="light" expand="lg" style={menuStyle}>
      <Container>
        <Navbar.Brand id={COMPONENT_IDS.NAVBAR_LANDING_PAGE} as={NavLink} to="/"><Image src="images/cash-companion-logo.png" width="70px" /></Navbar.Brand>
        <Navbar.Brand id={COMPONENT_IDS.NAVBAR_LANDING_PAGE} as={NavLink} to="/"><h1>Cash Companion</h1></Navbar.Brand>
        <Navbar.Toggle aria-controls={COMPONENT_IDS.NAVBAR_COLLAPSE} />
        <Navbar.Collapse id={COMPONENT_IDS.NAVBAR_COLLAPSE}>
          <Nav className="me-auto justify-content-start">
            {currentUser ? ([
              <Nav.Link id={COMPONENT_IDS.NAVBAR_ADD_SPENDING} as={NavLink} to="/add-spending" key="add-spending">Add Spending</Nav.Link>,
              <Nav.Link id={COMPONENT_IDS.NAVBAR_MY_SPENDING} as={NavLink} to="/my-spending" key="my-spending">My Spending</Nav.Link>,
            ]) : ''}
