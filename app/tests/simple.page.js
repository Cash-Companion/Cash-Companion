...
export const addExpensePage = new SimplePage(PAGE_IDS.ADD_EXPENSE);
export const editExpensePage = new SimplePage(PAGE_IDS.EDIT_EXPENSE);
export const listExpensePage = new SimplePage(PAGE_IDS.LIST_EXPENSE);
